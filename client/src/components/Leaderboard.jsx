    ...
    <div style={{
      ...
      <div style={{
        ...
        <div 
          ...
          style={{ flex: 1, overflowY: 'auto', padding: '15px', touchAction: 'pan-y', WebkitOverflowScrolling: 'touch' }} 
        >
          {isLoadingLeaderboard ? (
            <div style={{ textAlign: 'center', marginTop: '50px' }}>
              <p style={{ color: THEME.borderGold, fontSize: '24px', animation: 'float 1s infinite' }}>{text.lbLoading}</p>
            </div>
          ) : leaderboardData.length === 0 ? (
            <p style={{ textAlign: 'center', color: THEME.textSub, marginTop: '50px', fontSize: '18px' }}>{text.lbEmpty}</p>
          ) : (
          ...
          {userRankData && (
            <>
              <div style={{ textAlign: 'center', color: THEME.textSub, margin: '5px 0 15px 0', fontSize: '24px', fontWeight: 'bold' }}>⋮</div>
